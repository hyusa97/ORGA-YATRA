...
# --- LOGGED-IN USER SEES DASHBOARD ---
    ...
    if page == "Dashboard":
        ...
        st.download_button("⬇ Download Monthly Summary (CSV)", data=csv, file_name="monthly_summary.csv", mime="text/csv")
        ...
        st.download_button("⬇ Download Grouped Data", data=csv_grouped, file_name="grouped_data.csv", mime="text/csv")
        ...
        if "Date" in filtered_df.columns:
            ...
            st.warning("⚠ 'Date' column not found in investment data.")
